...
This folder contains everything needed to reproduce the code-generated panels in **Supp Figure 13**, including panel-specific data and (when needed) panel-specific external code.
...
- `SFig13.py`  
  Entry script to reproduce Supp Figure 13 (generates the figure and/or panel outputs).
...
### Default (SimSpace)
Most of Supp Figure 13 should run in the default environment:
```bash
...
```bash
python supp_figures/SFig13/SFig13.py
```
