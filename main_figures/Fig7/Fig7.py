...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_A1.png')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_B1.png')
...
plt.title('SimSpace Simulation')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_B2.png')
...
plt.title('CODEX Tumor Sample')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_B3.png')
...
plt.title('SimSpace Simulation')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_B4.png')
...
plt.title('CODEX Tumor Sample')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_B5.png')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig7_Panel_C.png')