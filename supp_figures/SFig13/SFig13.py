...
plt.savefig(f"{script_dir}/SFig13_scBSP.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_SPARK.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_Hotspot.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_MI.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_Giotto_kmeans.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_Giotto_rank.png", bbox_inches='tight')
...
plt.savefig(f"{script_dir}/SFig13_SpatialDE.png", bbox_inches='tight')