...
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig4_panel_A1.png')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig4_panel_A2.png')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig4_panel_B1.png')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig4_panel_B2.png')
