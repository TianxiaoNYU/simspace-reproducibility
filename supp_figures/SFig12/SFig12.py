...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig12_panel_C1.png')
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig12_panel_C2.png')
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig12_panel_C3.png')
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig12_panel_D1.png')
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(f'{script_dir}/SFig12_panel_D2.png')