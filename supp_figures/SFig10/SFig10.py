...
for i, kernel in enumerate(kernel_size):
    ...
    ax.set_ylabel('Y')
    plt.tight_layout()
    plt.savefig(f'{script_dir}/SFig10_panel_A1.png')

    ss.plot.spatial_pie(sim, spot_meta, (kernel,kernel))
    plt.savefig(f'{script_dir}/SFig10_panel_A{2+i}.png')
    plt.close()
...
for i, kernel in enumerate(kernel_size):
    ...
    ax.set_ylabel('Y')
    plt.tight_layout()
    plt.savefig(f'{script_dir}/SFig10_panel_B1.png')

    ss.plot.spatial_pie(sim, spot_meta, (kernel,kernel))
    plt.savefig(f'{script_dir}/SFig10_panel_B{2+i}.png')
    plt.close()
...
for i, kernel in enumerate(kernel_size):
    ...
    ax.set_ylabel('Y')
    plt.tight_layout()
    plt.savefig(f'{script_dir}/SFig10_panel_C1.png')

    ss.plot.spatial_pie(sim, spot_meta, (kernel,kernel))
    plt.savefig(f'{script_dir}/SFig10_panel_C{2+i}.png')
    plt.close()