...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_A1.png', dpi=250)
...
plt.savefig(f'{script_dir}/Fig5_panel_A2.png', dpi=250, bbox_inches='tight')
...
plt.savefig(f'{script_dir}/Fig5_panel_A3.png', dpi=250, bbox_inches='tight')
...
plt.savefig(f'{script_dir}/Fig5_panel_A4.png', dpi=250, bbox_inches='tight')
...
plt.savefig(f'{script_dir}/Fig5_panel_A5.png', dpi=250, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_B1.png', dpi=300)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_C1.png', dpi=300)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_B2.png', dpi=300)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_C2.png', dpi=300)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_B3.png', dpi=300)
...
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig5_panel_C3.png', dpi=300)
...
for i, kernel in enumerate(kernel_sizes):
    ...
    plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', title ='Metric')
    plt.tight_layout()
    plt.savefig(f'{script_dir}/Fig5_panel_D{i+1}.png', dpi=300)
