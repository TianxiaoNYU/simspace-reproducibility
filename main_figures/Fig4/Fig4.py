...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_B1.png', bbox_inches='tight', dpi=300)
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_B2.png', bbox_inches='tight', dpi=300)
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_B3.png', bbox_inches='tight', dpi=300)
...
plt.title('SimSpace Simulation')
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_D1.png', bbox_inches='tight', dpi=300)
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_D2.png', bbox_inches='tight', dpi=300)
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_D3.png', bbox_inches='tight', dpi=300)
...
plt.tight_layout()
plt.savefig(f'{script_dir}/Fig4_panel_E.png', bbox_inches='tight', dpi=300)