...
SimSpace is audited at version 0.3.2 (commit `ecf2855612871498dc89b8d43169229dfb8f6057`). Its row must be refreshed if the frozen manuscript software version changes before submission.
