...
This directory contains the standalone, code-generated panels for Figure 3.
The repository figure index and launchers use the finalized numbering.
...
- `Fig3.py`: entry script for Panels A-C
