"""Supplementary Figure 9: Gibbs-sweep sensitivity analysis for R1-8.

This analysis varies only the phenotype-level ``num_iterations`` parameter in
the reference-free configuration used for Supplementary Figure 3. It
...
def main() -> None:
    ...
    output_path = SCRIPT_DIR / "SFig9.png"
    figure.savefig(output_path, dpi=300, bbox_inches="tight")
    figure.savefig(EXAMPLE_DIR / "SFig9.png", dpi=300, bbox_inches="tight")
    plt.close(figure)
